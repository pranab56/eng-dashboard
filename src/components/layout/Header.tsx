    ...
    <div className='h-full flex items-center justify-between gap-2 px-8'>
      ...
      <div className="flex items-center gap-5">
        ...
        >
          ...
          {unreadCount > 0 && (
            <span className="absolute -top-1 -right-1 min-w-5 h-5 flex items-center justify-center bg-yellow-600 text-white font-bold text-[10px] rounded-full px-1 border border-white animate-pulse">
              {unreadCount}
            </span>
          )}
        </Link>
