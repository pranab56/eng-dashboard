  ...
  isRejecting?: boolean
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold . tracking-wider border ${badgeStyle}`}>
            {status}
          </span>
        );
      },
        ...
        return (
          <div className="flex items-center gap-2">
            <button
              ...
              className={`flex items-center justify-center h-9 w-9 rounded-md transition-all ${isPending
